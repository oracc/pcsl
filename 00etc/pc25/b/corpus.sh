...
cut -f1,7,11 ../../00cat/uruk-iv-iii.tsv | grep unpublished | grep III$ | cut -f1 | sort >t/u-3
cut -f1,7,11 ../../00cat/uruk-iv-iii.tsv | grep unpublished | grep IV$ | cut -f1 | sort >t/u-4
