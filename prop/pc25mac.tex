...
\font\slnmfontx="Ungkam Basic Bold:color=FF0000" at7.75pt
\font\slnmfonty="Ungkam Basic Bold:color=0000FF" at8.25pt
...
\def\slnamesx#1#2#3#4#5#6#7#8{%
   \global\oidtoks{#2}%
   \setbox\slnmbox=\hbox{#1}\ifdim\wd\slnmbox>1.25in
     \let\slnm\slnmfontx
     \else
