...
\def\beginpcsltab{\bgroup\offinterlineskip \lineskip1pt
...
\def\pcslrow#1#2#3#4#5#6#7#8#9{%
   \pcslheader
   \setbox\pcslbox\hbox to2in{\hsize2in\relax#1}%
   \pcslrowht=\ht\pcslbox \advance\pcslrowht\dp\pcslbox
   \setbox\pcslbox\vbox{#2}%
   \ifdim\ht\pcslbox>\pcslrowht \pcslrowht\ht\pcslbox \advance\pcslrowht\dp\pcslbox \fi
   \hbox to \hsize{%
         \vbox to\pcslrowht{\vfil\hbox to2in{\hsize2in\relax#1\hfil}\vfil}%
         \pquad\vbox to\pcslrowht{\vfil#2\vfil}%
         \pquad\vbox to\pcslrowht{\vfil#3\vbox to9pt{\vfil}\vfil}%
...
\def\slnames#1#2#3#4#5#6#7{%
    \vbox{%
        \hbox to2in{\slnm#1\hss}%
        \hbox{\hbox to.5\hsize{\pcssxx#4\hss}\hbox to.5\hsize{\hfil#3}}%
        \hbox{\hbox to.5\hsize{\helv#5\hfil}\hbox to.5\hsize{\hfil#2}}%
        \hbox to2in{\sldist#6\hss}%
    }%
}
