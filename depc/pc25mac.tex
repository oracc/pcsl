...
\font\pcssxxcvi="[/Users/stinney/orc/lib/fonts/PCSL.ttf]:+ss20,+liga,+cv01" at 14pt
\font\pcssxxcvii="[/Users/stinney/orc/lib/fonts/PCSL.ttf]:+ss20,+liga,+cv02" at 14pt
\font\pcssxxcviii="[/Users/stinney/orc/lib/fonts/PCSL.ttf]:+ss20,+liga,+cv03" at 14pt
\font\pcssxxcviv="[/Users/stinney/orc/lib/fonts/PCSL.ttf]:+ss20,+liga,+cv04" at 14pt
\font\pcssxxcvv="[/Users/stinney/orc/lib/fonts/PCSL.ttf]:+ss20,+liga,+cv05" at 14pt
\font\pcssxxcvvi="[/Users/stinney/orc/lib/fonts/PCSL.ttf]:+ss20,+liga,+cv06" at 14pt
...
\def\sqhboxn#1{\hbox to1.6in{\seven\rm#1\hfil}}
\def\sqhboxd#1{\hbox to1.6in{\quad#1\hfil}}
\def\sqhboxp#1{\hbox to.7in{\nine\rm#1\hfil}}
\def\sqhboxL#1{\hbox to3in{\nine\rm#1\hfil}}
\def\sqhboxl#1{\hbox to3.5in{\seven\rm#1\hfil}}

\def\beginseqdb{%\newpage
  \bgroup\offinterlineskip \lineskip1pt
  \ltfirstpage\the\pageno
  \setbox\seqdbheaderbox=\vbox{\vfuzz12pt%
     \seqdbrowx{\sqhboxn{NAME/DECOMP}}%
               {\sqhboxp{PUA}}%
               {\sqhboxL{LIG/.liga}}%
   }%
   %\righthdrinfo{}%
...
\def\seqdbrowx#1#2#3{%
     ...
     \nquadb\vbox to\seqdbrowht{\vfil\sqhboxp{#2}\vfil}%
     \nquadb\vbox to\seqdbrowht{\vfil\sqhboxL{#3}\vfil}%
     \hfil
   }%
   \kern12pt
   \hrule height1.5pt
...
%     \nquadb\vbox to\seqdbrowht{\vfil\sqhboxd{#2}\vfil}%
     \nquadb\vbox to\seqdbrowht{\vfil\sqhboxp{#3}\vfil}%
            \vbox to\seqdbrowht{%
              \vfil
              \sqhboxL{#4}%
              \vfil
